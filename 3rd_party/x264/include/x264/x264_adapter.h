...
namespace x264 {
    ...
    int  EncoderProcessFrame(int encoderId, unsigned char* buf, unsigned char* out, int* type);
    ...
    int  EncoderProcessFrameRGB(int encoderId, unsigned char* buf, unsigned char* out, int* type);
